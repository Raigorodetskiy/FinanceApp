...
describe('FinancialMetricsPage typography and layout regressions', () => {
  ...
  it('renders Russian name at 18px and aliases at same size, red color, line-height 1.5', () => {
    expect(FINANCIAL_METRICS_NAME_FONT_SIZE).toBe(18);
    expect(FINANCIAL_METRICS_NAME_LINE_HEIGHT).toBe(1.5);
    expect(FINANCIAL_METRICS_ALIASES_FONT_SIZE).toBe(18);
  ...
  it('keeps description text at 18px with readable line-height', () => {
    expect(FINANCIAL_METRICS_DESCRIPTION_FONT_SIZE).toBe(18);
  ...
  it('renders unit, formula, example and interpretation with at least 18px and formula in code block', () => {
    expect(FINANCIAL_METRICS_META_FONT_SIZE).toBeGreaterThanOrEqual(18);
