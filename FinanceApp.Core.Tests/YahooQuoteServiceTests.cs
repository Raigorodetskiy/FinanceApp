...
public class YahooQuoteServiceTests
{
    ...
    private static YahooQuoteService CreateService(HttpMessageHandler handler)
    {
        ...
        return new YahooQuoteService(httpClientFactory, NullLogger<YahooQuoteService>.Instance);
    }
