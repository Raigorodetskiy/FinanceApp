      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'list', items: [
            ...
            'В «24 ч.» и «Сегодня» разрыв между закрытием Frankfurt и началом сессии США остаётся естественным gap: приложение не дорисовывает несуществующие свечи.',
            ...
            'Ручное действие «Перезагрузить историю» заново запрашивает дневные и внутридневные интервалы (включая 5m→10m и 1h), поэтому после него возможна смена последних свечей.',
          ] },
        ],
      },
      {
