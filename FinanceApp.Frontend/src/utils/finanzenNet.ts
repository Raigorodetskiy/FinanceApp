/** Valid finanzen.net slug: lowercase letters, digits, hyphens, and underscores; 1–120 characters; must start with a letter or digit. */
const FINANZEN_NET_SLUG_RE = /^[a-z0-9][a-z0-9_-]{0,119}$/;

/**
 * Returns true when `slug` is a non-empty string that matches the allowed
 * finanzen.net slug format (`^[a-z0-9][a-z0-9_-]{0,119}$`).
 */
